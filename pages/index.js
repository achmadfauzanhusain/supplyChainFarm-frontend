    ...
    <>
      ...
      <div className="pb-14">
        ...
        <div className="mt-32 md:mt-44 text-center">
          <h1 className={`${urbanist.className} text-4xl md:text-5xl font-bold bg-linear-to-r from-[#0D6EFD] bg-clip-text inline-block to-white text-transparent`}>Prevent Counterfeiting of <br className="sm:hidden" /> Your Products</h1>
